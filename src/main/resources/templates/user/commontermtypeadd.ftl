...
<div class="panel-body">
   <div style="padding: 8px;margin: 8px" class="row">
		...
		<form novalidate="novalidate" method="post"  id="form" role="form" class="order-form">
               ...
               <div class="col-md-12" style="height:50px">
			           <div class="col-md-2"></div>
					   <div class="col-md-2"><span style="text-align: right;color: #666;  padding: 8px">* 术语分类名称</span></div>
					   <div class="col-md-5">
 ...
 function submitForm(){
     if($('#name').val() && $('#did').val() ){
		 var targetUrl ="";
		 if($('#id').val()){
	         targetUrl = "/user/commontermtype/edit"; 
	     }else{
	         targetUrl = "/user/commontermtype/add"; 
	     }
	     ...
	     $.ajax({
		    ...
		    success:function(res){  
		       if(res == 'success'){
		           location.href="/user/commontermtype/list";
		       }else{
