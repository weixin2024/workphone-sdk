...
<div class="panel-body">
   <div style="padding: 8px;margin: 8px" class="row">
		...
		<form novalidate="novalidate" method="post"  id="form" role="form" class="order-form">
			    <div class="col-md-12" style="height:50px">
					   ...
					   <div class="col-md-2"><span style="text-align: right;color: #666;  padding: 8px">* 客服操作员账号</span></div>
					   <div class="col-md-5">
			    ...
			    <div class="col-md-12" style="height:50px">
			           <div class="col-md-2"></div>
					   <div class="col-md-2"><span style="text-align: right;color: #666;  padding: 8px">* 客服操作员账号密码</span></div>
					   <div class="col-md-5">
			   ...
			   <div class="col-md-12" style="height:50px">
			           <div class="col-md-2"></div>
					   <div class="col-md-2"><span style="text-align: right;color: #666;  padding: 8px">* 客服操作员账号昵称</span></div>
					   <div class="col-md-5">
 ...
 function submitForm(){
	 ...
	 if( $('#account').val() &&  $('#password').val() &&  $('#nickname').val() &&  $('#did').val() ){
		 var targetUrl ="";
		 if($('#id').val()){
	         targetUrl = "/user/account/edit"; 
	     }else{
	         targetUrl = "/user/account/add"; 
	     }
	     ...
	     $.ajax({
		    ...
		    success:function(res){  
		       if(res == 'success'){
		           location.href="/user/account/list";
		       }else{
		          $("#flabel").html("<font color='red'>保存失败，请检查客服账号是否存在重复！</font>");
		       }
		    },   
	        error : function() {   
	            alert("异常！");   
