...
public class AccountService {
	...
	public PageBean<AccountInfo> queryAccountInfo(AccountVo info) {
		...
		List<AccountInfo> resultList = accountDao.queryAccountInfo(page, info.getAccount(),info.getType(),info.getCid(),info.getDid());
		Integer totalResult = accountDao.queryAccountInfoCount(page, info.getAccount(),info.getType(),info.getCid(),info.getDid());
	...
	public String insert(AccountInfo user) {
		String res = "success";
		try {
	...
	public String update(AccountInfo user) {
		String res = "success";
		try {
