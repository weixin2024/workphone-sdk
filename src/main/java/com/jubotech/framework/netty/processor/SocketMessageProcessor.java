...
public class SocketMessageProcessor {
	...
	public  void  handler(ChannelHandlerContext ctx, Object msg) {
        ...
        case  ContactLabelDelNotice  : {//联系人标签删除通知
        	log.debug("socket:msgtype=ContactLabelAddNotice");
